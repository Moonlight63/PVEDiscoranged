...
```
~# wget https://raw.githubusercontent.com/Moonlight63/PVEDiscoranged/master/PVEDiscordDark.sh
~# bash PVEDiscordDark.sh install
```
Or this oneliner
```
bash <(curl -s https://raw.githubusercontent.com/Moonlight63/PVEDiscoranged/master/PVEDiscordDark.sh ) install
```
...
`REPO` is in format `Username/Repository` and defaults to `Moonlight63/PVEDiscoranged` (this repository).    
