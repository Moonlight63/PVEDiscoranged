...
latestversion=`curl -s "https://api.github.com/repos/Moonlight63/PVEDiscoranged/releases/latest" | awk -F '"' '/tag_name/{print $4}'`
...
then
    ...
    then
        echo -ne "Downloading...\n"
        wget -O "PVEDiscordDark.py" "https://raw.githubusercontent.com/Moonlight63/PVEDiscoranged/master/PVEDiscordDark.py"
        echo "$latestversion" > $file
