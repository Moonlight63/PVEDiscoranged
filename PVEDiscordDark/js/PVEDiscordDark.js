...
const patchCharts = function() {
	...
	Ext.chart.theme.Base.prototype.config.axis.defaults.style.strokeStyle = COLOR_ORANGED;
...
function patchGaugeWidget() {
	...
	Proxmox.panel.GaugeWidget.prototype.defaultColor = COLOR_ORANGED;
